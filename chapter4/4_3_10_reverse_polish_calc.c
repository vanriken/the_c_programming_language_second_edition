/***********************************************************************
    filename:   4_3_10_reverse_polish_calc.c
    author:     Alexandros Rikos
    date:       YYYY-MM-DD

    description:

    comments: An alternate organization uses getline to read an entire input line;
              This makes getch() and ungetch() unnecessary. Revise te calculator to
              use this approach.
***********************************************************************/
